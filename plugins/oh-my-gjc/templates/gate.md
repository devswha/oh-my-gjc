---
description: 현재 세션에 근거 기반 응답 페르소나 보정과 gate-briefing을 켜거나 끈다. 인자 없거나 'on'이면 켜고, 'off'면 끈다.
argument-hint: "[on|off]"
---

사용자가 현재 세션의 응답 수준 보정 + gate-briefing을 토글했다.
...
- 인자가 `off`이면 → **끄기**:
  임시 응답 페르소나 보정과 강제 gate-briefing을 함께 해제한다.
