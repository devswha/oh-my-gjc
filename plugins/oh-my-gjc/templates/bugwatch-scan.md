...
```bash
BW="$(ls -d ~/.gjc/plugins/cache/plugins/oh-my-gjc___oh-my-gjc___*/bin/collect.ts 2>/dev/null | sort -V | tail -1)"
[ -z "$BW" ] && BW="$(ls -d ./.gjc/plugins/cache/plugins/oh-my-gjc___oh-my-gjc___*/bin/collect.ts 2>/dev/null | sort -V | tail -1)"
[ -z "$BW" ] && [ -f plugins/oh-my-gjc/bin/collect.ts ] && BW="plugins/oh-my-gjc/bin/collect.ts"
echo "BW=$BW"
```
