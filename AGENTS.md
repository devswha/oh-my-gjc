...
- Everything else (easy-answer, gate-briefing, presets, branch-flow, extragoal, fable, gjc-bugwatch) + the `example-plugin` template: no external prerequisites (branch-flow/worktree need a git repo; fable needs Fable 5 model access).
