...
- Everything else (easy-answer, gate-briefing, presets, branch-flow, worktree, extragoal, fable, gjc-bugwatch) + the `example-plugin` template: no external prerequisites (worktree needs a git repo; fable needs Fable 5 model access).
