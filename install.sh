...
#
# One install brings ALL 9 capabilities — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 9 capabilities, all native. No further required steps.
