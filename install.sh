...
#
# One install brings ALL 6 skills + 9 commands (/omg + 8 /omg:*) — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 6 skills + 9 commands (/omg + 8 /omg:*), all native surfaces installed.
