...
#
# One install brings ALL 8 skills + 13 commands (/omg + 12 /omg:*) — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 8 skills + 13 commands (/omg + 12 /omg:*), all native. No further required steps.
