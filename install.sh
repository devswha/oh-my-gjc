...
#
# One install brings ALL 14 capabilities — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 14 capabilities, all native. No further required steps.
