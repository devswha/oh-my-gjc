#!/usr/bin/env bash
# oh-my-gjc — one-shot installer (single plugin suite).
#
...
✓ oh-my-gjc installed — one plugin, 5 skills + 5 commands (/omg + 4 /omg:*), all native surfaces installed.
...
════════════════ v0.28.0 cutover ════════════════
  ...
  Old raw.githubusercontent.com/devswha/oh-my-gajae-code URLs no longer work.
  An old oh-my-gajae-code marketplace registration may remain until targeted CLI cleanup is proven.
══════════════════════════════════════════════════
DONE
