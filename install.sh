...
#
# One install brings ALL 6 skills + 8 commands (/omg + 7 /omg:*) — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajae-code installed — one plugin, 6 skills + 8 commands (/omg + 7 /omg:*), all native surfaces installed.
