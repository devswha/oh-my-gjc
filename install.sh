...
#
# One install brings ALL 9 skills + 14 commands (/omg + 13 /omg:*) — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 9 skills + 14 commands (/omg + 13 /omg:*), all native. No further required steps.
