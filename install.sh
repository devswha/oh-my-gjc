...
#
# One install brings ALL 9 skills + /omg:* commands — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 9 skills + /omg:* commands, all native. No further required steps.
