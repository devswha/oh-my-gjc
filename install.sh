...
#
# One install brings ALL 8 skills + 13 /omg:* commands — there are no separate/optional plugins. Legacy
...
✓ oh-my-gajaecode installed — one plugin, 8 skills + 13 /omg:* commands, all native. No further required steps.
